        ...
        <div className="header-lower">
          ...
          <div className="action-box">
            ...
            <div className="header-btn">
              <Link className="header-btn-one" href="#"><span className="btn-text"><i className="icon fa-regular fa-lock-keyhole"></i> Sign Up</span></Link>
              <Link className="header-btn-two" href="#"><span className="btn-text">Request a Demo</span></Link>
            </div>
