	...
	return (
		...
		<div className="items-container row" ref={isotopeContainer}>
			...
			<div className="product-block masonry-item small-column all cat-1 cat-3 cat-5 product lenses mb-50 col-lg-3 col-md-6">
				<div className="inner-box">
					<div className="image-box">
						<div className="image"><Link href="/shop-product-details"><img src="/assets/images/resource/products/5.jpg" alt="Image" /></Link></div>
						<div className="icon-box">
							<Link href="/shop-product-details" className="ui-btn"><i className="fa fa-heart"/></Link>
							<Link href="shop-cart" className="ui-btn"><i className="fa fa-shopping-cart"/></Link>
						</div>
			...
			<div className="product-block masonry-item small-column all cat-2 cat-3 cat-4 product lenses mb-50 col-lg-3 col-md-6">
				<div className="inner-box">
					<div className="image-box">
						<div className="image"><Link href="/shop-product-details"><img src="/assets/images/resource/products/6.jpg" alt="Image" /></Link></div>
						<div className="icon-box">
							<Link href="/shop-product-details" className="ui-btn"><i className="fa fa-heart"/></Link>
							<Link href="shop-cart" className="ui-btn"><i className="fa fa-shopping-cart"/></Link>
						</div>
			...
			<div className="product-block masonry-item small-column all cat-1 cat-2 cat-5 product lenses mb-50 col-lg-3 col-md-6">
				<div className="inner-box">
					<div className="image-box">
						<div className="image"><Link href="/shop-product-details"><img src="/assets/images/resource/products/7.jpg" alt="Image" /></Link></div>
						<div className="icon-box">
							<Link href="/shop-product-details" className="ui-btn"><i className="fa fa-heart"/></Link>
							<Link href="shop-cart" className="ui-btn"><i className="fa fa-shopping-cart"/></Link>
						</div>
			...
			<div className="product-block masonry-item small-column all cat-1 cat-4 cat-5 product lenses mb-50 col-lg-3 col-md-6">
				<div className="inner-box">
					<div className="image-box">
						<div className="image"><Link href="/shop-product-details"><img src="/assets/images/resource/products/8.jpg" alt="Image" /></Link></div>
						<div className="icon-box">
							<Link href="/shop-product-details" className="ui-btn"><i className="fa fa-heart"/></Link>
							<Link href="shop-cart" className="ui-btn"><i className="fa fa-shopping-cart"/></Link>
						</div>
