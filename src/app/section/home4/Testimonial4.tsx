...
const testimonials: Testimonial[] = [
  {
    ...
    text: `"Implementing this platform completely transformed the way operate. streamlining workflows to giving full visibility into every project, our team has saved."`,
...
export default function TestimonialSectionLayout4() {
  return (
    <section className="testimonial-section-layout4">
      <div className="large-container">
        <div className="outer-box pt-120">
          <div className="bg-image bg">
            <img
              src="/assets/images/background/testimonial4-1.jpg"
