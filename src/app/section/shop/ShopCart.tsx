...
const ShopCart = () => {
  ...
  return (
    <>
      <section>
        <div className="container pt-120 pb-0">
                  ...
                  <table className="table table-striped table-bordered tbl-shopping-cart">
                    ...
                    <tbody>
                      ...
                      <tr className="cart_item">
                        ...
                        <td colSpan={2}>&nbsp;</td>
                        <td><button type="button" className="theme-btn btn-style-one" data-loading-text="Please wait..."><span className="btn-title"><span className="btn-text">Update Cart</span></span></button></td>
                      </tr>
                    </tbody>
                  </table>
                </div>
                ...
                <div className="row">
                  <div className="col-md-5">
                    ...
                    <form className="form" action="/">
                      ...
                      <div className="mb-30">
                        <button type="button" className="theme-btn btn-style-one" data-loading-text="Please wait..."><span className="btn-title"><span className="btn-text">Update Totals</span></span></button>
                      </div>
                    </form>
                  </div>
                  ...
                  <div className="col-md-5">
                    ...
                    <button type="button" className="theme-btn btn-style-one" data-loading-text="Please wait..."><span className="btn-title"><span className="btn-text">Proceed to Checkout</span></span></button>
                  </div>
                </div>
              </div>
            </div>
